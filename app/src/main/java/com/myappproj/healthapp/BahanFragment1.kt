...
class BahanFragment1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val textBahan1 = view.findViewById<ImageView>(R.id.back_arrow1)
        ...
        textBahan1.setOnClickListener {
            // Navigasi ke beranda saat tombol diklik
            findNavController().navigate(R.id.action_bahanFragment1_to_berandaFragment)
        }
